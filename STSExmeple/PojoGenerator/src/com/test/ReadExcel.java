...
public class ReadExcel {
	private void readExcel() throws Exception{
		...
		FileInputStream fileInputStream = new FileInputStream(new File("/Users/698675/apps/examples/STSExmeple/PojoGenerator/src/com/test/Book1.xlsx"));
	...
	private Map<String, Class<?>> cellIterationForHeader(Iterator<Cell> cellIterator) {
		...
		while (cellIterator.hasNext()) 
		{
		    ...
		    {
		        case Cell.CELL_TYPE_STRING:
		            excelHeaderMap.put(cell.getStringCellValue().replace(" ","_"), String.class);
		            break;
		    }
		}
